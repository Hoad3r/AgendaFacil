...
export default function Booking() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 bg-background min-h-screen">
      ...
      <h1 className="text-2xl font-bold text-foreground mb-6">Agendar Serviço</h1>
      ...
      <div className="bg-card rounded-2xl border border-border p-6 mb-6">
        <p className="text-sm text-muted-foreground mb-1">{est.name}</p>
                ...
                <button
                  ...
                  className={`py-2 rounded-lg text-sm font-medium transition-colors ${
                    selectedSlot === slot
                      ...
                      : 'bg-muted/50 text-foreground hover:bg-accent hover:text-accent-foreground border border-border'
                  }`}
                >
                  {slot}
                </button>
        ...
        <div className="space-y-4">
          <div className="bg-muted/50 rounded-xl p-4 space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-foreground">{date ? format(parseISO(date), 'dd/MM/yyyy') : '-'}</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Button className="flex-1" disabled={booking} onClick={handleConfirm}>
              {booking ? 'Confirmando...' : 'Confirmar'}
            </Button>
          </div>
        </div>
      </Modal>
