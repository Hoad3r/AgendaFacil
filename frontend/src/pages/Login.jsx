...
export default function Login() {
  ...
  function handleGoogleLogin() {
    ...
    window.location.href = `${api}/api/google-login?callbackURL=${cb}`;
  }
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 dark:bg-slate-950 flex-col justify-center px-16">
        ...
        <p className="text-slate-400 text-lg">Gerencie seus serviços e horários em um só lugar.</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" className="pl-9" placeholder="seu@email.com" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} required />
              </div>
            </div>
            <div className="space-y-1.5">
